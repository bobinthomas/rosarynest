/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 34bae2f0fd1ce2bc67e49764cb156bee)
// Runtime types generated with workerd@1.20260630.1 2025-06-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	NEXT_PUBLIC_BOOKING_ENGINE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "ADMIN_USERNAME" | "ADMIN_PASSWORD_HASH" | "ADMIN_SESSION_SECRET" | "NEXT_PUBLIC_BOOKING_ENGINE_URL" | "RESEND_API_KEY" | "NEXT_PUBLIC_SITE_URL">> {}
}
